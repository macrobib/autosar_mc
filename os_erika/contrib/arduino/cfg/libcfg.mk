...
EE_SRCS_ARDUINO_SDK += hardware/arduino/cores/arduino/HID.c
EE_SRCS_ARDUINO_SDK += hardware/arduino/cores/arduino/IPAddress.cpp
EE_SRCS_ARDUINO_SDK += hardware/arduino/cores/arduino/new.c
...
EE_OBJS_ARDUINO_SDK := 							       \
	$(addprefix $(OBJDIR)/,						       \
		$(patsubst %.cpp,%.o,					       \
			$(patsubst %.c,%.o,				       \
				$(patsubst %.s,%.o,$(EE_SRCS_ARDUINO_SDK))     \
			)						       \
		)							       \
	)
...
$(ARDUINO_SDK_LIB): $(EE_OBJS_ARDUINO_SDK)
	$(VERBOSE_PRINTAR) $(EE_AR) $(COMPUTED_OPT_AR) $@ $^

OPT_LIBS += $(ARDUINO_SDK_LIB)
ALL_LIBS += $(ARDUINO_SDK_LIB)
